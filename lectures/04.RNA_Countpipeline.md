...
RNA-seq workflow: gene-level exploratory analysis and differential expression [Tutorial] (https://master.bioconductor.org/packages/release/workflows/vignettes/rnaseqGene/inst/doc/rnaseqGene.html)


Same operation using  Galaxy (https://training.galaxyproject.org/training-material/topics/transcriptomics/tutorials/rna-seq-reads-to-counts/tutorial.html)
